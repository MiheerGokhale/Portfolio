...
const Leetcode: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
    return (
...
const Resume: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
    ...
    >
      ...
      {/* Lines like resume text */}
      <line x1="176" y1="128" x2="336" y2="128" />
      <line x1="176" y1="192" x2="336" y2="192" />
      <line x1="176" y1="256" x2="336" y2="256" />
      <line x1="176" y1="320" x2="336" y2="320" />
      <line x1="176" y1="384" x2="256" y2="384" />
      
      {/* Small "profile picture" circle */}
...
const socials: Social[] = [
    ...
    { label: "X", href: "https://x.com/miheer_27", Icon: Twitter },
    { label: "Email", href: "mailto:miheergokhale24@gmail.com", Icon: Mail },
    {label: "Leetcode", href: "https://leetcode.com/u/Miheer_Gokhale/", Icon: Leetcode},
    {label: "Resume", href: "https://drive.google.com/file/d/1fp2X-XOpx9Cpg1ekHZWJJF0xXEyXk-Nz/view?usp=sharing", Icon: Resume}
]

export const Social = ({className}: {className?: string}) => {
    return (
        <div className={cn("flex justify-between w-full gap-x-2",
            className
        )}>
